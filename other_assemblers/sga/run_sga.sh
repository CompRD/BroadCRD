...
if [ $# -ne 2 ]; then
  echo "Usage: `basename $0` readsA readsB" 1>&2
  exit 1
fi
...
# Program paths
SGA_HEAD=/wga/scr4/iainm/other_assemblers/sga/build
SGA_BIN=${SGA_HEAD}/stuff/bin/sga
BWA_BIN=bwa
SAMTOOLS_BIN=samtools
BAM2DE_BIN=${SGA_HEAD}/stuff/bin/sga-bam2de.pl
ASTAT_BIN=${SGA_HEAD}/stuff/bin/sga-astat.py
DISTANCE_EST=${SGA_HEAD}/stuff/bin/DistanceEst
...
$SGA_BIN preprocess --phred64 --pe-mode 1 -o reads.pp.fastq $IN1 $IN2
