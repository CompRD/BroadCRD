...
if [ $# -ne 1 ]; then
  echo "Usage: `basename $0` long_proto_read_file_head" 1>&2
  exit 1
fi



long_proto_read_head=$1
...
IN1=${read_head}.A.fastq.gz
IN2=${read_head}.B.fastq.gz


date


export PATH=/wga/scr4/assemblers/sga_curr1/stuff/bin/:${PATH}
...
# Program paths
SGA_BIN=/wga/scr4/assemblers/sga_curr1/stuff/bin/sga
BWA_BIN=bwa
SAMTOOLS_BIN=samtools
BAM2DE_BIN=/wga/scr4/assemblers/sga_curr1/stuff/bin/sga-bam2de.pl
ASTAT_BIN=/wga/scr4/assemblers/sga_curr1/stuff/bin/sga-astat.py
DISTANCE_EST=/wga/scr4/assemblers/sga_curr1/stuff/bin/DistanceEst
